...
namespace QuicNet.Infrastructure.Settings
{
    public class QuicSettings
    {
        ...
        /// </summary>
        public const bool ShouldBufferPacketsBeforeConnection = true;
